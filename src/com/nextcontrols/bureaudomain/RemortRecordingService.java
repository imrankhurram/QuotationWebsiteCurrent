...
public class RemortRecordingService {
	...
	public RemortRecordingService() {

	}
	
	public RemortRecordingService(int pid,int pnumberofsensors,int pperyearOneYear,
			int ppermonthOneYear,int pperyearThreeYear,int ppermonthThreeYear,int pperyearFiveYear,int ppermonthFiveYear) {
		super();
		this.id = pid;
		numberofsensors= pnumberofsensors;
