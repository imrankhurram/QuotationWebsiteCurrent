...
@ManagedBean(name = "pdfhtmlExp")
@SessionScoped
public class PDFExporterFromHTMLPageBean implements Serializable {
	/**
	 * 
	 */
	...
	public PDFExporterFromHTMLPageBean() {
	...
	public void createPDF() throws DocumentException, IOException {
		...
		HttpSession session = (HttpSession) facesContext.getExternalContext()
				.getSession(false);
		quotationBean = (QuotationCreationPageBean) session
	...
	public String getSecondPage() {
		...
		quotationcoveringletter += city
				...
				+ "</div>"
				+ "<div style='font-family: Arial, Verdana; font-size: 10pt; font-variant: normal; line-height: normal; font-weight: normal; font-style:normal;'>"
				+ quotationBean.bean.getUser().getFirstName() + " "
				+ quotationBean.bean.getUser().getLastName() + "<br/>"
				+ quotationBean.bean.getUser().getTitle() + ",&nbsp;" + "<br/>"
				+ quotationBean.bean.getUser().getPhoneNumber() + "<br/>"
				+ quotationBean.bean.getUser().getUsername() + "</div>";
		...
		// return
		// "<div style='font-family: Arial, Verdana; font-size: 10pt; font-variant: normal; line-height: normal; font-weight: normal; font-style:normal;'><br/><br/><br/><br/><br/><br/><br/></div>"+quotationBean.getQuotation().getQuotationcoveringletter();
...
//					"pdfDownloadForm:animateLoading");
	...
	public void writeToResponse(HttpServletResponse response)
		...
		response.setHeader("Content-disposition", "attachment;filename="
				+ quotationBean.getQuotation().getQuotationref() + ".pdf");
